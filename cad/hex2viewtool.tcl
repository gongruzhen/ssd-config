...
#process var1-4 to address_data1
    ...
    set address_byte3 [lappend $line_var22 $line_var23]
    set address_byte2 [lappend $line_var20 $line_var21]
    set address_byte1 [lappend $line_var12 $line_var13]
    set address_byte0 [lappend $line_var10 $line_var11]
    ...
    set line_var2s [split  $line_var4 ""]
    ...
    set data_byte3 [lappend $line_var22 $line_var23]
    set data_byte2 [lappend $line_var20 $line_var21]
    set data_byte1 [lappend $line_var12 $line_var13]
    set data_byte0 [lappend $line_var10 $line_var11]
...
#process var5-8 to address_data2
    set line_var1s $line_var5s
    set line_var2s $line_var6s
    set line_var3s $line_var7s
    set line_var4s $line_var8s
